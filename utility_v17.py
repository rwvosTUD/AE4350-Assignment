...
class Actor:
    ...
    def __init__(self, stateTS_size, stateUT_size, action_size, model_hyper):
        ...
        self.use_batchNorm_tsconv = model_hyper["use_batchNorm_tsconv"]
...
class Agent:
    ...
    def act(self, state, utils: list, use_local = True):
        '''
    ...
    def _reward_type8(self, agent, profit: float, 
        ...
        n_holds = util_lst[6] # concurrent holds, resets after a sell/buy
        impossible = util_lst[7] # invalid action 
        l = 754 # l = util_lst[8] # length of data
        terminate = util_lst[9]
    ...
    def _reward_type9(self, agent, profit: float, 
        ...
        if not terminate: 
            ...
            if at == 0 or impossible:
                ...
                # buy action
                reward = (profit+(ptn-pt))*prob # notice we also have the opportunity cost in this case!
                    
            elif at == 2:
                # sell action
                reward = (profit+(ptn-pt)*-1)*prob # notice we also have the opportunity cost in this case!
